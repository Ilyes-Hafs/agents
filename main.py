...
def file_agent(user_input: str):
    ...
    if is_convert:
        ...
        src = os.path.expanduser(src)  # handles ~/... paths
        ...
        if fmt == "pdf":
            cmd += ["--pdf-engine=xelatex"]  # most reliable on Arch/CachyOS
        ...
        # If the user described content in their message, use the coder/general agent to generate it
        ...
        # Offer to convert after creating
